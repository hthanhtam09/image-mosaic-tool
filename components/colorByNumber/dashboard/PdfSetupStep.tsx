                ...
                <div className="max-w-5xl mx-auto w-full mb-6 flex items-center justify-between px-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-3">
                            <div className={`flex items-center gap-2 px-3 py-1 rounded-lg text-[10px] font-bold border shadow-sm transition-all duration-500 ${uploadedFolders.color ? 'bg-green-500 border-green-400 text-white' : 'bg-gray-500/5 border-gray-500/10 text-(--text-muted)'}`}>
                            ...
                            <div className={`flex items-center gap-2 px-3 py-1 rounded-lg text-[10px] font-bold border shadow-sm transition-all duration-500 ${uploadedFolders.uncolor ? 'bg-blue-600 border-blue-400 text-white' : 'bg-gray-500/5 border-gray-500/10 text-(--text-muted)'}`}>
