...
export default function PdfSetupStep({
    ...
    return (
        <div id="pdf-setup" className="flex-1 flex flex-col py-2 overflow-y-auto no-scrollbar">
                ...
                <div className="max-w-5xl mx-auto w-full mb-6 flex items-center justify-between px-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-wrap gap-2 ml-4">
                            <div className={`flex items-center gap-1.5 px-2 py-1 rounded text-[10px] font-bold border shadow-sm transition-all duration-500 ${uploadedFolders.color ? 'bg-green-500 border-green-400 text-white' : 'bg-gray-500/5 border-gray-500/10 text-[var(--text-muted)]'}`}>
                            ...
                            <div className={`flex items-center gap-1.5 px-2 py-1 rounded text-[10px] font-bold border shadow-sm transition-all duration-500 ${uploadedFolders.uncolor ? 'bg-blue-600 border-blue-400 text-white' : 'bg-gray-500/5 border-gray-500/10 text-[var(--text-muted)]'}`}>
            ...
            <div className="max-w-5xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-4 h-full">
                            ...
                            <div className="flex flex-col items-center w-full gap-3">
                                <div className="flex items-center gap-2 max-w-full overflow-x-auto pb-2 no-scrollbar">
                                    {prefixPages.map((page, i) => (
                                        <div key={i} className="shrink-0 relative w-12 h-16 rounded border border-[var(--border-default)] overflow-hidden shadow-sm">
                ...
                <div className="bg-[var(--bg-secondary)] rounded-2xl p-5 border border-[var(--border-subtle)] flex flex-col items-center justify-center relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
                        ...
                        <p className="text-xs text-[var(--text-secondary)] text-center mb-5">Design applied to all left-side pages (cycles through multiple images)</p>
                        ...
                        {bgImages.length > 0 ? (
                            <div className="flex flex-col items-center w-full gap-3">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button onClick={() => bgInputRef.current?.click()} className="px-3 py-1.5 text-xs font-medium text-[var(--accent)] hover:bg-[var(--accent)]/10 rounded-lg transition-colors">Add More</button>
                                </div>
                            </div>
                        ) : (
                            <button onClick={() => bgInputRef.current?.click()} className="px-4 py-2 bg-[var(--bg-primary)] border border-[var(--border-default)] rounded-lg shadow-sm text-sm font-medium hover:bg-black/5 transition-colors">Select Images</button>
                        )}
                ...
                {!globalExportPalette && directImages.length === 0 && (
                    <div className="bg-[var(--bg-secondary)] rounded-2xl p-5 border border-[var(--border-subtle)] flex flex-col items-center justify-center relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
                            ...
                            <p className="text-xs text-[var(--text-secondary)] text-center mb-4">Fun facts and text blocks via CSV</p>

                            <div className="flex items-center gap-2 mb-4 w-full bg-black/5 p-2 rounded-lg justify-between border border-[var(--border-subtle)]">
                                <span className="text-xs font-medium text-[var(--text-primary)]">Include Writing Box</span>
                            ...
                            {csvFileName && csvData.length > 0 ? (
                                <div className="flex flex-col items-center gap-4 w-full">
                                    <div className="w-full max-w-50 bg-[var(--bg-primary)] rounded border border-[var(--border-default)] overflow-hidden">
                ...
                {(globalExportPalette || directImages.length > 0) && (
                    <div className="bg-[var(--bg-secondary)] rounded-2xl p-5 border border-[var(--border-subtle)] flex flex-col items-center justify-center relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
                            ...
                            <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-1">Palette Images</h3>
                            <p className="text-xs text-[var(--text-secondary)] text-center mb-5">Upload custom palettes for the left pages</p>
                            ...
                            {paletteImages.some(Boolean) ? (
                                <div className="flex flex-col items-center w-full gap-3">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button onClick={() => paletteInputRef.current?.click()} className="px-3 py-1.5 text-xs font-medium text-[var(--accent)] hover:bg-[var(--accent)]/10 rounded-lg transition-colors">Change Images</button>
                                    </div>
                                </div>
                            ) : (
                                <button onClick={() => paletteInputRef.current?.click()} className="px-4 py-2 bg-[var(--bg-primary)] border border-[var(--border-default)] rounded-lg shadow-sm text-sm font-medium hover:bg-black/5 transition-colors">Upload Images</button>
                            )}
                ...
                {(globalExportPalette || directImages.length > 0) && (
                    <div className="bg-[var(--bg-secondary)] rounded-2xl p-5 border border-[var(--border-subtle)] flex flex-col items-center justify-center relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
                            ...
                            <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-1">Solutions Collage Pages</h3>
                            ...
                            {solutionCollagePages.length > 0 ? (
                                <div className="flex flex-col items-center w-full gap-3">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        {directImages.length > 0 && (
                                            <button onClick={() => solutionCollageInputRef.current?.click()} className="px-3 py-1.5 text-xs font-medium text-[var(--accent)] hover:bg-[var(--accent)]/10 rounded-lg transition-colors">Change Images</button>
                                        )}
                                    </div>
                                </div>
                            ) : directImages.length > 0 ? (
                                <button onClick={() => solutionCollageInputRef.current?.click()} className="px-4 py-2 bg-[var(--bg-primary)] border border-[var(--border-default)] rounded-lg shadow-sm text-sm font-medium hover:bg-black/5 transition-colors">Upload Images</button>
                            ) : (
                                <div className="flex flex-col items-center justify-center bg-black/5 rounded-xl border border-[var(--border-subtle)] w-full py-6">
                                    ...
                                    <span className="text-sm font-medium text-[var(--text-primary)]">Ready to Auto Add</span>
                                </div>
                            )}
                            {directImages.length === 0 && (
                                <button onClick={() => solutionNamesInputRef.current?.click()} className="mt-3 px-3 py-1.5 text-xs font-medium text-[var(--accent)] border border-[var(--accent)]/30 bg-[var(--accent)]/5 hover:bg-[var(--accent)]/10 rounded-lg transition-colors">
                                    Import Names CSV
                ...
                {directImages.length > 0 && (
                    <div className="bg-[var(--bg-secondary)] rounded-2xl p-5 border border-[var(--border-subtle)] flex flex-col items-center justify-center relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
                            ...
                            <p className="text-xs text-[var(--text-secondary)] text-center mb-5">Select a background theme for your book</p>
