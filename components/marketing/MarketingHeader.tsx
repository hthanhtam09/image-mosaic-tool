...
function UserMenu() {
  ...
  useEffect(() => {
    ...
    if (!supabaseUrl || !supabaseKey) { setUser(null); return }
    ...
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        ...
        >
          ...
          <Link href="/studio/projects" className="block rounded-lg px-3 py-2 text-sm text-text-primary transition hover:bg-white/5">
            Open Tool
          </Link>
