...
import origin from "@/app/assets/img/origin.png";
import uncolored from "@/app/assets/img/uncolored.png";
import colored from "@/app/assets/img/colored.png";
    ...
    <section className="relative flex min-h-[88vh] flex-col items-center justify-center overflow-hidden bg-[radial-gradient(#ffffff09_1px,transparent_1px)] bg-[length:24px_24px] pb-[60px] pt-20">
      ...
      <div className="animate-rise relative z-[2] w-full max-w-[1100px] px-8 text-center">
        ...
        <p className="mx-auto text-lg text-text-secondary">
          Upload, pick a mosaic style, export a print-ready PDF. Built for KDP
          creators.
        </p>
      ...
      <div
        className="animate-rise relative z-[2] mx-auto mt-12 w-full max-w-[1100px]"
          ...
          <div className="ws-shot grid min-h-[720px] grid-cols-[1fr_240px]">
            <div className="ws-canvas flex items-center justify-center bg-bg-primary p-6">
              <div className="convert-demo" id="convertDemo">
                <img
                  className="cd-layer cd-photo block h-full w-full object-cover"
                  id="cdPhoto"
                  src={optimized(origin.src, 1920)}
                  alt="Source Photo"
                  draggable={false}
                />
                <img
                  className="cd-layer cd-mosaic block h-full w-full object-cover"
                  id="cdUncolored"
                  src={optimized(uncolored.src, 1920)}
                  alt="Numbered Page"
                  draggable={false}
                ...
                <img
                  className="cd-layer cd-mosaic block h-full w-full object-cover"
                  id="cdMosaic"
                  src={optimized(colored.src, 1920)}
                  alt="Colored Page"
                  draggable={false}
                  style={{ clipPath: 'inset(0 100% 0 0)' }}
                />
                ...
                <div className="absolute bottom-3 left-3 z-[4] inline-flex items-center gap-2 rounded-full border border-[#c0cde340] bg-black/60 px-3 py-1.5 text-xs text-white backdrop-blur-[6px]">
                  ...
                  <span id="cdStage">Converting</span>{" "}
