...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    y: 39,
    cta: "Get Studio",
    features: ["Everything in Pro", "Bulk folder upload", "Priority rendering", "Commercial license"],
  },
];
...
export const FAQ: [string, string][] = [
  ...
  ["Can I sell books made with Mosaci?", "Pro lets you publish watermark-free pages. The Studio plan adds a commercial license covering KDP and print-on-demand at any volume."],
